import{E as m}from"./BufferObject-CwJVMjkB.js";import{r as c}from"./Program-CY0rg90Q.js";import{x as p,s as l}from"./Program-CY0rg90Q.js";import"./main-C2GI9Q3q.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-DlpeMeMs.js";import{m as b}from"./Texture-BAQFu_4u.js";import{o as h}from"./VertexArrayObject-DK9YpLh7.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
