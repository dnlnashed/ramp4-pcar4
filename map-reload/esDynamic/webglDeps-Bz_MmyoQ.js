import{E as m}from"./BufferObject-Bxd6VKYc.js";import{r as c}from"./Program-DavuWA38.js";import{x as p,s as l}from"./Program-DavuWA38.js";import"./main-ba6BIG1C.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-CosYKXPE.js";import{m as b}from"./Texture-CwmE_dhp.js";import{o as h}from"./VertexArrayObject-edB4DUMJ.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
