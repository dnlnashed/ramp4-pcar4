...
import { ref as f, computed as N, markRaw as se, defineComponent as O, inject as ve, reactive as Ae, watch as xt, onBeforeUnmount as dt, resolveDirective as M, withDirectives as P, openBlock as v, createElementBlock as w, withKeys as os, withModifiers as Kt, onMounted as Je, normalizeClass as oe, normalizeStyle as Ri, createVNode as re, Transition as $i, withCtx as ee, createBlock as W, resolveDynamicComponent as as, mergeProps as ns, TransitionGroup as Ci, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as m, vShow as ls, resolveComponent as K, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as cs, Teleport as us, getCurrentInstance as ps, useTemplateRef as ui, createApp as Oi, toRaw as Se, h as ds, render as Gt, defineAsyncComponent as hs } from "vue";
...
class J extends Ze {
  ...
  static fromESRI(e, t) {
    return new J(t, [e.x, e.y], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ms({
      x: this.x,
  ...
  static fromGeoJSON(e, t) {
    return new J(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class Ps {
  ...
  async projectExtent(e, t) {
    ...
    const a = new ie("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
...
const Rt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Rt(), t = ve("iApi"), i = N(() => e.maptipPoint), s = N(() => e.maptipInstance), o = N(() => e.content), a = Ae([]), l = f(!1);
    a.push(
      xt(i, () => {
        if (i.value) {
...
const Hs = ["data-cy"], ji = /* @__PURE__ */ O({
  ...
  setup(r) {
    const e = f(!1), t = f(null), i = Ae([]), s = f(), o = f(), a = f(), l = r;
    i.push(
      xt(e, () => {
        t.value.update();
      })
...
const ir = ["content"], sr = { class: "flex items-center text-left" }, rr = { class: "select-text cursor-text" }, or = ["content"], ar = {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = de(), { t: i } = Y(), s = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = f([]), p = Ae([]);
    p.push(
      xt(c, (A) => {
...
const xo = ["content"], So = {
  ...
  setup(r) {
    ...
    const s = async () => {
      ...
      const n = new J("geolocation", l, _.latLongSR(), !0);
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((c) => c.identifyMode === Q.HYBRID || c.identifyMode === Q.SYMBOLIC) && (s = this.esriView.hitTest({
      ...
      const u = c.results.map((p) => p.graphic.isAggregate === !0 ? Promise.resolve(this.esriView?.whenLayerView(p.layer)).then((g) => {
        const h = g?.createQuery();
        return h.aggregateIds = [p.graphic.getObjectId()], g?.queryFeatures(h);
      }).then(({ features: g }) => g.map((h) => ({
        layerId: h.layer.id,
        layerIdx: 0,
        oid: h.attributes[h.layer.objectIdField]
      }))) : {
        layerId: p.layer.id,
        layerIdx: 0,
      ...
      return Promise.all(u).then((p) => p.flat());
    }));
    const o = {
      geometry: i.mapPoint,
      hitTest: s
...
class Qe extends ri {
  ...
  makeEsriLayerConfig(e) {
    ...
    ) || i : t.displayField = i, t.outFields = ["*"], delete t.url, this.configDrawOrder(e, t), e.pointClustering && (t.featureReduction = e.pointClustering), t;
  }
  onLoadActions() {
...
class fn extends ri {
  ...
  makeEsriLayerConfig(e) {
    ...
    return (e.initialFilteredQuery || e.permanentFilteredQuery) && (t.definitionExpression = this.filter.getCombinedSql()), this.configDrawOrder(e, t), e.pointClustering && (t.featureReduction = e.pointClustering), t;
  }
  onLoadActions() {
...
const Mn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-B70p1JKo.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-C7PObmTr.js"), "../fixtures/basemap/index.ts": () => import("./index-CRlV8mun.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BDqie2wi.js"), "../fixtures/details/index.ts": () => import("./index-B3v-UkwU.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BcSplQRl.js"), "../fixtures/export-legend/index.ts": () => import("./index-BFTEAfbb.js"), "../fixtures/export-map/index.ts": () => import("./index-s8yeqJoB.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-qCTlO-Eg.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-D9MYfgJQ.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DpTCsEc8.js"), "../fixtures/export-title/index.ts": () => import("./index-e-VzQetx.js"), "../fixtures/export/index.ts": () => import("./index-qFrqH3dD.js"), "../fixtures/extentguard/index.ts": () => import("./index-DDHzhI5v.js"), "../fixtures/gazebo/index.ts": () => import("./index-CX1X49cu.js"), "../fixtures/geosearch/index.ts": () => import("./index-Cm1gHpHI.js"), "../fixtures/grid/index.ts": () => import("./index-DzlRXBs6.js"), "../fixtures/help/index.ts": () => import("./index-IFYNw1kN.js"), "../fixtures/hilight/index.ts": () => import("./index-uaHEmVsy.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-Dtizu2d8.js"), "../fixtures/legend/index.ts": () => import("./index-C7j3rrE9.js"), "../fixtures/mapnav/index.ts": () => import("./index-MRIGVr9Y.js"), "../fixtures/metadata/index.ts": () => import("./index-CDOQC1EM.js"), "../fixtures/northarrow/index.ts": () => import("./index-DwHasExs.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BNh5fo1B.js"), "../fixtures/panguard/index.ts": () => import("./index-DA2Sx8Xf.js"), "../fixtures/scrollguard/index.ts": () => import("./index-MnlswSCl.js"), "../fixtures/settings/index.ts": () => import("./index-feOTfZTj.js"), "../fixtures/snowman/index.ts": () => import("./index-BluaAOtt.js"), "../fixtures/wizard/index.ts": () => import("./index-mH9P7l8s.js") });
class Pn extends Z {
  /**
...
const Un = /* @__PURE__ */ Ne(Dn, [["render", Gn], ["__scopeId", "data-v-a3c61802"]]), Bn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BP63OYjp.js"), "../fixtures/basemap/screen.vue": () => import("./screen-BB8BL12c.js"), "../fixtures/export/screen.vue": () => import("./screen-agCSqLYv.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CCHqVQ5s.js"), "../fixtures/grid/screen.vue": () => import("./screen-D3KusLAS.js"), "../fixtures/help/screen.vue": () => import("./screen-DJeTzLY-.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-D5jzeCq9.js"), "../fixtures/legend/screen.vue": () => import("./screen-CKYIL7Ya.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BYsnismA.js"), "../fixtures/settings/screen.vue": () => import("./screen-SDFm562o.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BCvpqDEr.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Tue Apr 15 11:35:49 2025 -0400", hash: "a53bbd246e3258c9fa41d92c47500064ea340951" };
console.info(
