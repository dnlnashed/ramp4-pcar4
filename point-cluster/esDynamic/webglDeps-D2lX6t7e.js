import{E as m,o as p}from"./VertexArrayObject-7j3ko-3a.js";import{x as l,s as u}from"./FramebufferObject-Cj_rkWST.js";import{r as c}from"./ProgramTemplate-xULooD6U.js";import{e as d,a as $}from"./ProgramTemplate-xULooD6U.js";import"./main-CTKpuxz5.js";import{t as x}from"./NestedMap-Ddo7BfvO.js";import{w as b}from"./Texture-C63dlfU4.js";class h{constructor(e){this._rctx=e,this._store=new x}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,r,i){const s=this._store.get(e,t);if(s!=null)return s.ref(),s;const o=new c(this._rctx,e,t,r,i);return o.ref(),this._store.set(e,t,o),o}get test(){}}function _(n){const{options:e,value:t}=n;return typeof e[t]=="number"}function g(n){let e="";for(const t in n){const r=n[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
