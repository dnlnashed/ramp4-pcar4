import{E as m}from"./BufferObject-CmGFXje_.js";import{r as c}from"./Program-ClW_FUJc.js";import{x as p,s as l}from"./Program-ClW_FUJc.js";import"./main-C872cFCP.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-Be3cjM36.js";import{m as b}from"./Texture-DYjXo6P3.js";import{o as h}from"./VertexArrayObject-DAfStF9F.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
