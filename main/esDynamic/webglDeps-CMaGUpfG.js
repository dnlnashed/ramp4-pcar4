import{E as m}from"./BufferObject-gq45u1QF.js";import{r as c}from"./Program-CqLre23k.js";import{x as p,s as l}from"./Program-CqLre23k.js";import"./main-Czl6u6q4.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-Dk5LEnv_.js";import{m as b}from"./Texture-gaSdkxxY.js";import{o as h}from"./VertexArrayObject-B4l1GGO_.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
